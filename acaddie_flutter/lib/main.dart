...
class _HistoryView extends StatelessWidget {
  ...
  const _HistoryView({required this.onLoadSimulation});
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('SIMULATION AUDIT TRAIL',
                style: GoogleFonts.inter(
                    color: const Color(0xFF38BDF8),
                    fontSize: 10,
                    fontWeight: FontWeight.w700)),
          ...
          Text('Simulation History',
              style: GoogleFonts.inter(
                  ...
                  fontSize: 26,
                  fontWeight: FontWeight.w700)),
          Text('${history.length} simulation(s) recorded in this session.',
              style: GoogleFonts.inter(
            ...
            Center(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Icon(Icons.history,
                        color: const Color(0xFF1E293B), size: 64),
                    const SizedBox(height: 12),
                    Text('No simulations yet.',
                        style: GoogleFonts.inter(
                            color: const Color(0xFF475569), fontSize: 14)),
                    Text('Run a simulation from the Studio.',
                        style: GoogleFonts.inter(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text('${sim.confidence}% confidence',
                              style: GoogleFonts.inter(
                                  color: const Color(0xFF475569),
                                  fontSize: 10)),
                        ],
...
class _CourseCatalogView extends StatefulWidget {
  ...
  const _CourseCatalogView({required this.onSimulateCourse});
...
class _CourseCatalogViewState extends State<_CourseCatalogView> {
  ...
  Widget build(BuildContext context) {
    ...
    final selected = _selectedId != null
        ? courses.firstWhere((c) => c.id == _selectedId,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('OBE CURRICULUM — AUST CSE 2025-2026',
                style: GoogleFonts.inter(
                    color: const Color(0xFF38BDF8),
                    fontSize: 10,
                    fontWeight: FontWeight.w700)),
          ...
          Text('Course Catalog',
              style: GoogleFonts.inter(
                  ...
                  fontSize: 26,
                  fontWeight: FontWeight.w700)),
          Text('${courses.length} core courses • Click to inspect topics & CLOs.',
              style: GoogleFonts.inter(
                  color: const Color(0xFF64748B), fontSize: 13)),
          const SizedBox(height: 20),
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          'Sem ${c.semester} • ${c.credit} Cr • ${c.topics.length} topics',
                          style: GoogleFonts.inter(
                        ...
                        children: [
                          Text('${selected.code} — ${selected.name}',
                              style: GoogleFonts.inter(
                                  ...
                                  fontSize: 18)),
                          Text(
                              'Semester ${selected.semester} • ${selected.credit} Credits • ${selected.type}',
                              style: GoogleFonts.inter(
                                  color: const Color(0xFF64748B),
                                  fontSize: 12)),
                        ],
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('CLOs (${selected.clos.length})',
                                style: GoogleFonts.inter(
